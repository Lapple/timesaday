...
var Dashboard = (function (_Component) {
    function Dashboard(props) {
        ...
        this.state = {
            cards: (0, _immutable.fromJS)(props.cards)
        };
    }
    ...
    _createClass(Dashboard, [{
        ...
        key: 'render',
        value: function render() {
            return _react.DOM.div({ className: 'dashboard' }, this.state.cards.map(this.renderCard, this), _react.DOM.div({ className: 'dashboard__item' }, newCard({
...
},{"./count-card":1,"./new-card":3,"./time-card":4,"immutable":7,"react":162}],3:[function(require,module,exports){
'use strict';
...
},{"immutable":7,"react":162}],4:[function(require,module,exports){
'use strict';
...
},{"hhmmss":6,"react":162}],5:[function(require,module,exports){
...
var dashboard = (0, _react.createFactory)(_componentsDashboard2['default']);

document.addEventListener('DOMContentLoaded', function () {
    var cards = JSON.parse(document.getElementById('cards').innerHTML.trim());

    (0, _react.render)(dashboard({ cards: cards }), document.getElementById('dashboard'));
});

},{"./components/dashboard":2,"react":162}]},{},[163]);
